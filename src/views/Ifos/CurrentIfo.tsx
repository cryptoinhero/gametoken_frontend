...
import { Text, Heading, BaseLayout, Button, LinkExternal, Flex, Image } from '@gametoken/uikit'
    ...
    <div>
      ...
      <LaunchIfoCallout>
        <div>
          ...
          <List>
            <li>{TranslateString(596, 'Buy GME and BNB tokens')}</li>
            <li>{TranslateString(598, 'Get GME-BNB LP tokens by adding GME and BNB liquidity')}</li>
          </List>
          <Flex mb="16px">
            <LinkExternal href="https://swap.gametoken.finance/#/swap" mr="16px">
              {TranslateString(1060, 'Buy GME')}
            </LinkExternal>
            <LinkExternal href="https://swap.gametoken.finance/#/add/BNB/0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82">
        ...
        <div>
          ...
          <div>
            ...
            <Button
              as="a"
              href="https://docs.google.com/forms/d/e/1FAIpQLSdBO99MHdk3KkqcxYbGWpJwT4WMTKugz3PTv7URFAL0BG5Gsw/viewform"
              external
            >
